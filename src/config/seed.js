    ...
    .then(() => {
      Person.create(
        ...
        },
        {
          ...
          description:
            'The Betrayer, Lord of Outland, Ruler of the Naga, The Demon Hunter, The Lord Of Shadows, Master of the Illidari, The Child of Light and Shadow, The Chosen One',
          age: 15032,
        },
        {
        ...
        },
        {
          ...
          description:
            'Warchief (of the Horde), The Dark Lady, The Banshee Queen, Mistress Sylvanas',
        },
      );
    });
};
